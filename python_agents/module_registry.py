...
_ALL: List[ModuleSpec] = [
    ...
    _spec(
        ...
        "agent",
        source="event_bus", key="strategist_agent", period=60,
    ...
    _spec(
        ...
        "agent",
        source="event_bus", key="ghost_simulator_agent", period=60,
    ...
    _spec(
        ...
        "agent",
        source="event_bus", key="auditor_agent", period=300,
    ...
    _spec(
        ...
        "agent",
        source="event_bus", key="pattern_matcher_agent", period=120,
    ...
    _spec(
        ...
        "brain",
        source="event_bus", key="fast_brain", period=60,
    ...
    _spec(
        ...
        "brain",
        source="event_bus", key="qwen_oracle_brain", period=120,
    ...
    _spec(
        ...
        "detector",
        source="event_bus", key="hmm_regime", period=180,
    ...
    _spec(
        ...
        "learning",
        source="event_bus", key="conformal", period=600,
        events=(),
        deps=("meta_labeler",),
    ),
    _spec(
    ...
    _spec(
        ...
        "learning",
        source="event_bus", key="alpha_drift_monitor", period=600,
